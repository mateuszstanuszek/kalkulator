...
/**
 * @author Mateusz Stanuszek Dokumentacja techniczna inna wiadomosc cos nowego
 */
...
class calculator extends JFrame implements ActionListener {
		...
		if (e.getSource() == btn1) {
			...
			if (operation != 0 & str_number != "") {
				...
				case 1: {
					...
					result = dodawanie(int_number1, int_number2);
				...
				case 2: {
					...
					kelime = str_number.split("\\-");
					int_number2 = Integer.parseInt(kelime[1].replace("=", ""));
					result = odejmowanie(int_number1, int_number2);
					txt.setText(str_number + Double.toString(result));
					break;
				}
				case 3: {
					...
					kelime = str_number.split("\\*");
					int_number2 = Integer.parseInt(kelime[1].replace("=", ""));
					result = mnozenie(int_number1, int_number2);
					txt.setText(str_number + Double.toString(result));
					break;
				}
				case 4: {
					...
					kelime = str_number.split("\\/");
					int_number2 = Integer.parseInt(kelime[1].replace("=", ""));
					result = dzielenie(int_number1, int_number2);
					txt.setText(str_number + Double.toString(result));
					break;
				}
				}
	...
	public static double dodawanie(double first, double second) {
		return first + second;
	}
	
	public static double odejmowanie(double first, double second) {
		return second - first ; // wops blad O_o
	}
	
	public static double mnozenie(double first, double second) {
		return first * second;
	}
	
	public static double dzielenie(double first, double second) throws IllegalArgumentException {
		if(second==0) {
